...
export const removeItemFromCart = (character_id) => {
  const cart = getCartItems();
  const deleteCart = cart.filter((c) => c._id !== character_id);
